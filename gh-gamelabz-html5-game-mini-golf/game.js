(() => {
  ...
  function newHole(reset) {
    ...
    best = bestKey(); bestEl.textContent = best ? String(best) : '–';
  ...
  function draw() {
    ...
    ctx.fillStyle = 'rgba(255,255,255,0.8)'; ctx.font = '12px system-ui'; ctx.textAlign = 'center';
    ctx.fillText('⛳', hole.x, hole.y + 4);
