...
⛳ Mini Golf — a modern, dependency-free HTML5 game built with Canvas and vanilla JavaScript.

🎮 **Play Online:** https://gamelabz.github.io/html5-game-mini-golf/
...
Aim, set power, and sink the ball in as few strokes as possible across putting puzzles.
...
- Drag-to-aim putting
- Wall and obstacle bounces
- Stroke counter and par
