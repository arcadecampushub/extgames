...
🎯 Pinball — a modern, dependency-free HTML5 game built with Canvas and vanilla JavaScript.

🎮 **Play Online:** https://gamelabz.github.io/html5-game-pinball/

## 📸 Screenshot

![Pinball](assets/images/screenshot.png)

## 🎯 About

Launch the ball, work the flippers, and rack up points by hitting bumpers and targets.
