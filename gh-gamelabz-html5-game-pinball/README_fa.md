...
🎯 Pinball — یک بازی HTML5 مدرن و بدون وابستگی، ساخته‌شده با Canvas و جاوااسکریپت خالص.

🎮 **بازی آنلاین:** https://gamelabz.github.io/html5-game-pinball/
...
توپ را پرتاب کن، فلیپرها را کار بینداز و با زدن به ضربه‌گرها و اهداف امتیاز جمع کن.

## 🕹️ کنترل‌ها

- پرتاب: Space
- فلیپرها: کلیدهای چپ/راست
- توقف موقت: P

## ✨ ویژگی‌ها

- فیزیک فلیپر و ضربه‌گر
- ضریب امتیاز
- ذخیره توپ و جان‌ها
