// IAU 3-letter constellation abbreviation -> full name. (Matches the catalog `con` field.)
export const NAMES = {
  ...
  Sct: 'Scutum', Ser: 'Serpens', Se1: 'Serpens', Se2: 'Serpens', Sex: 'Sextans', Tau: 'Taurus', Tel: 'Telescopium', Tri: 'Triangulum',
