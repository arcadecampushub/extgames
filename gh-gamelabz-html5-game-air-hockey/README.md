...
🏒 Air Hockey — a modern, dependency-free HTML5 game built with Canvas and vanilla JavaScript.

🎮 **Play Online:** https://gamelabz.github.io/html5-game-air-hockey/

## 📸 Screenshot

![Air Hockey](assets/images/screenshot.png)

## 🎯 About

Slide your paddle to slam the puck past the AI and score before the clock runs out.
