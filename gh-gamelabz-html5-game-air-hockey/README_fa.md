...
🏒 Air Hockey — یک بازی HTML5 مدرن و بدون وابستگی، ساخته‌شده با Canvas و جاوااسکریپت خالص.

🎮 **بازی آنلاین:** https://gamelabz.github.io/html5-game-air-hockey/
...
راکتت را بکش تا پاک را از هوش مصنوعی رد کنی و قبل از تمام شدن زمان امتیاز بگیر.

## 🕹️ کنترل‌ها

- حرکت راکت: کشیدن موس / لمس
- توقف موقت: P
- شروع دوباره: R
